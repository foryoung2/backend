...
public class VenueElasticsearchIndexInitializer {
    ...
    private IndexSettings.Builder configureSettings(IndexSettings.Builder settings) {
        ...
        return settings
                ...
                .analysis(analysis -> analysis
                        ...
                        .analyzer(
                                "venue_index_analyzer",
                                analyzer -> analyzer
                                        .custom(custom -> custom
                                                .charFilter("remove_spaces")
                                                .tokenizer("standard")
                                                .filter("lowercase", "venue_ngram")
                                        )
                        )

                        .analyzer(
                                "venue_search_analyzer",
                                analyzer -> analyzer
                                        .custom(custom -> custom
                                                .charFilter("remove_spaces")
                                                .tokenizer("standard")
    ...
    private TypeMapping.Builder configureMappings(TypeMapping.Builder mappings) {
        ...
        return mappings
                ...
                .properties(
                        ...
                        property -> property
                                .text(text -> text
                                        .analyzer("venue_index_analyzer")
                                        .searchAnalyzer("venue_search_analyzer")
                                )
                );
