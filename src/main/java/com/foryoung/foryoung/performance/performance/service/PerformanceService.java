...
public class PerformanceService {
    ...
    public PerformanceDetailResponse getPerformance(Long performanceId) {
        ...
        long ratingCount = recordRepository.countRatedRecords(performanceId);

        return PerformanceDetailResponse.from(performance, schedules, averageRating, ratingCount);
